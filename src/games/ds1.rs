...
pub unsafe fn ds1_init(process: &mut Process) -> GameFuncs
{
    ...
    let game_funcs = GameFuncs {
        ...
        flag_control: ds1_flag_control,
        flag_cutscene: ds1_flag_cutscene,
        flag_save: ds1_flag_save
    };
...
pub unsafe fn ds1_flag_control(process: &mut Process) -> bool
{
    let pointers = POINTERS.as_ref().unwrap();
...
pub unsafe fn ds1_flag_save(process: &mut Process) -> bool
{
    let pointers = POINTERS.as_ref().unwrap();
